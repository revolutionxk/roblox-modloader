...
namespace RBX
{
	...
	RML_ASSERT_OFFSET(ContentProviderTemporaryIdFactory, buffers_mutex, 88);
	RML_ASSERT_OFFSET(ContentProviderTemporaryIdFactory, buffers, 96);
	RML_ASSERT_SIZE(ContentProviderTemporaryIdFactory, 160);
#else
